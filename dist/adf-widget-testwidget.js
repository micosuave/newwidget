...
$templateCache.put("{widgetsPath}/testwidget/src/view.html","<div class=card style=\"margin: 0.5rem;padding: 0.2rem;text-align: left;overflow: scroll; height: 50rem;border: 0.1rem solid #110000;\" ng-if=pj.editable><textarea id=iframeElement ckeditor=ckdefault ng-model=item.digest ng-model-options=\"{ updateOn: \'default blur\', debounce: {\'default\': 1000, \'blur\': 0} }\"></textarea></div><iframe srcdoc=\"{{item.digest | trustAsHTML}}\" style=width:100%; class=\"card card-rounded\"></iframe><ng-annotate-text text=item.digest class=\"card card-rounded\"></ng-annotate-text>");}]);})(window);