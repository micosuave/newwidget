...
$templateCache.put("{widgetsPath}/testwidget/src/ckeditor.html","<div class=card style=\"margin: -0.5rem;padding: 0rem;text-align: left;overflow: scroll; height: 50rem;border: 0.1rem solid #110000;\" ng-if=pj.editable><div class=card-header ng-if=!draft.isRoot><h3 class=card-title>{{draft.title}}</h3></div><div id=iframeElement ckeditor=config.editor ng-model=draft.content ng-model-options=\"{ updateOn: \'default blur\', debounce: {\'default\': 1000, \'blur\': 0} }\" class=card-block contenteditable=true style=width:100%;height:100%;></div></div><div id=draftdocument class=\"card card-block\" ng-if=!pj.editable><ng-annotate-text text=draft.content></ng-annotate-text><div ng-repeat=\"node in draft.roarlist\" node=\"{{node.id || node}}\" style=\"padding-right: 0rem;\"><h2 class=card-title style=\"margin-bottom:0px;font-family:\'Arial\', sans serif;\">{{node.title}}</h2><ng-annotate-text text=\"node.content || node.details\"></ng-annotate-text><div ng-repeat=\"node in node.roarlist\" node=\"{{node.id || node}}\" style=\"padding-right: 0rem;\"><h3 class=card-title style=\"margin-bottom:0px;font-family:\'Arial\', sans serif;\">{{node.title}}</h3><ng-annotate-text text=\"node.content || node.details\"></ng-annotate-text><div ng-repeat=\"node in node.roarlist\" node=\"{{node.id || node}}\" style=\"padding-right: 0rem;\"><h4 class=card-title style=\"margin-bottom:0px;font-family:\'Arial\', sans serif;\">{{node.title}}</h4><ng-annotate-text text=\"node.content || node.details\"></ng-annotate-text><div ng-repeat=\"node in node.roarlist\" node=\"{{node.id || node}}\" style=\"padding-right: 0rem;\"><h5 class=card-title style=\"margin-bottom:0px;font-family:\'Arial\', sans serif;\">{{node.title}}</h5><ng-annotate-text text=\"node.content || node.details\"></ng-annotate-text><div ng-repeat=\"node in node.roarlist\" node=\"{{node.id || node}}\" style=\"padding-right: 0rem;\"><h6 class=card-title style=\"margin-bottom:0px;font-family:\'Arial\', sans serif;\">{{node.title}}</h6><ng-annotate-text text=\"node.content || node.details\"></ng-annotate-text><div ng-repeat=\"node in node.roarlist\" node=\"{{node.id || node}}\"><label class=lead style=\"margin-bottom:0px;font-family:\'Arial\', sans serif;\">{{node.title}}</label><ng-annotate-text text=\"node.content ||node.details\"></ng-annotate-text></div></div></div></div></div></div></div>");
